...
document.getElementById('explore').addEventListener('click', () => {
  window.open('https://www.blockchain.com/btc/address/' + document.getElementById('public-address').value);
});
...
Compressed Version
Private Key (WIF): ${document.getElementById('private-key-wif-compressed').value}
Public Address: ${document.getElementById('public-address-compressed').value}

Uncompressed Version
Private Key (WIF): ${document.getElementById('private-key-wif').value}
